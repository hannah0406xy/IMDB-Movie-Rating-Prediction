...
library(boot)
library(egg)
setwd("D:/Liuyifei/McGill/MGSC661/Midterm")
df <- read_xlsx("IMDB_training.xlsx")
attach(df)
...
df <- read_excel("/Users/lijintao/Desktop/McGill/FALL24/MGSC_661 (R)/midterm/IMDb_training.xlsx")
